...
register_test("Path class")
register_test("path.new", tests.test_path_new)
register_test("path.check", tests.test_path_check)
register_test("path.comparator", tests.test_path_comparator)
register_test("path.sort", tests.test_path_sort)
register_test("path:branching_points_sorted", tests.test_path_branching_points_sorted)
register_test("path:count_intermediate", tests.test_path_count_intermediate)
register_test("path:has_intermediate", tests.test_path_has_intermediate)
register_test("path:set_start", tests.test_path_set_start)
register_test("path:set_finish", tests.test_path_set_finish)
register_test("path:get_point", tests.test_path_get_point)
register_test("path:get_points", tests.test_path_get_points)
register_test("path:random_intermediate_point", tests.test_path_random_intermediate_point)
register_test("path:point_in_path", tests.test_path_point_in_path)
register_test("path:insert_between", tests.test_path_insert_between)
register_test("path:insert_at", tests.test_path_insert_at)
register_test("path:insert_before", tests.test_path_insert_before)
register_test("path:insert_after", tests.test_path_insert_after)
register_test("path:insert", tests.test_path_insert)
register_test("path:remove", tests.test_path_remove)
register_test("path:remove_previous", tests.test_path_remove_previous)
register_test("path:remove_next", tests.test_path_remove_next)
register_test("path:remove_at", tests.test_path_remove_at)
register_test("path:extend", tests.test_path_extend)
register_test("path:shorten", tests.test_path_shorten)
register_test("path:shorten_by", tests.test_path_shorten_by)
register_test("path:cut_off", tests.test_path_cut_off)
register_test("path:all_points", tests.test_path_all_points)
register_test("path:all_positions", tests.test_path_all_positions)
register_test("path:length", tests.test_path_length)
register_test("path:subdivide", tests.test_path_subdivide)
register_test("path:unsubdivide", tests.test_path_unsubdivide)
register_test("path:split_at", tests.test_path_split_at)
register_test("path:transfer_points_to", tests.test_path_transfer_points_to)
register_test("path:clear_intermediate", tests.test_path_clear_intermediate)
register_test("path:make_straight", tests.test_path_make_straight)
register_test("path:make_wave", tests.test_path_make_wave)
register_test("path:make_slanted", tests.test_path_make_slanted)
register_test("vector.comparator", tests.test_vector_comparator)
